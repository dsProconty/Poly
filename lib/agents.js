...
3. Para mercados MATCH_WINNER o ADVANCE en ligas conocidas, apuesta al FAVORITO:
   - YES > 55%: el favorito es YES → apuesta YES
   - YES < 45%: el favorito es NO → apuesta NO (NO tiene >55% de probabilidad)
   - El bot SIEMPRE debe apostar al lado con mayor probabilidad de ganar
   - NUNCA apostar YES en un mercado donde YES < 45% a menos que tengas información concreta que justifique el upset
   - VALUE=LOW es aceptable — no saltes solo por edge pequeño
4. REC_SIDE debe reflejar el LADO GANADOR (el favorito), no siempre YES
5. REC_PROB debe ser tu estimación real del equipo/lado que recomiendas, no el precio del mercado
