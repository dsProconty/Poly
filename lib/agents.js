...
${hasContext ? 'Usa el contexto actual para mejorar tu estimación.' : 'Sin contexto disponible: usa la probabilidad implícita y tu conocimiento general.'}

Reglas:
- VALUE=LOW es aceptable — no marques SKIP solo porque el edge sea pequeño.
- Marca SKIP=true solo si: la pregunta NO es sobre ganador del partido, es una liga completamente desconocida, o el mercado parece inválido.
- Si el mercado es NBA/MLB/NHL/NFL/UFC/Tennis/Soccer de liga conocida, SKIP debe ser false.
