...
const PROPS = [
  ...
  // Eventos disciplinarios/administrativos — NO son resultados de partidos
  'removed from','banned from','suspended from','excluded from','disqualified from',
  'fired from','resign from','retire from','stripped of',
  'receive a ban','receive a suspension','face suspension',
  // Props de inning/cuarto/periodo
